...
class Settings:
    ...
    def __init__(self):
        ...
        self.TOKENIZER_NAME = os.getenv("TOKENIZER_NAME", "BAAI/bge-m3")
        self.EMBEDDING_MODEL_DIMENSION = int(os.getenv("EMBEDDING_MODEL_DIMENSION", "1024"))
        self.EMBEDDING_CHUNK_SIZE = int(os.getenv("EMBEDDING_CHUNK_SIZE", "512"))
        ...
        self.REFRESH_TOKEN_EXPIRE_DAYS = int(os.getenv("ACCESS_TOKEN_EXPIRE_MINUTES", "30"))
        ...
        self.DATABASE_URL = os.getenv("DATABASE_URL", "postgresql+asyncpg://postgres:postgres@db:5432/sevap")
